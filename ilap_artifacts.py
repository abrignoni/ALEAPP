...
from scripts.artifacts.acquiring_contacts3 import get_acquiring_contacts3
from scripts.artifacts.providers_calendar import get_providers_calendar
...
tosearch = {
    ...
    'acquiring_contacts3':('Contacts', '**/contacts3.db'),
    'providers_calendar':('Calendars', '**/com.android.providers.calendar/db/calendar.db')
    }
'''
