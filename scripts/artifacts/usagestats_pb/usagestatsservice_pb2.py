...
_INTERVALSTATSPROTO_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='locus_id_index', full_name='com.android.server.usage.IntervalStatsProto.Event.locus_id_index', index=15,
...
IntervalStatsProto = _reflection.GeneratedProtocolMessageType('IntervalStatsProto', (_message.Message,), {
