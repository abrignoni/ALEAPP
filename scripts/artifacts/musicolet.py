__artifacts_v2__ = {
    "musicolet_library": {
        ...
        "notes": "One row per row of TABLE_SONGS in "
                 ...
                 "tags. Play Count is the lifetime count, and the app keeps three rolling "
                 "counters beside it, reported here as Plays This Week, Plays This Month and "
                 "Plays This Year. All four held the same value on every row of the tested "
                 "image; the only plays happened in the same week they were counted in. How the "
                 "rolling counters behave over a longer period was not exercised. Resume "
    ...
    "musicolet_playlists": {
        ...
        "notes": "One row per song per list, read from the app's own JSON files under "
                 ...
                 "arrays. There is no timestamp in either file, "
