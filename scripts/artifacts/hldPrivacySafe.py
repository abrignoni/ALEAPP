__artifacts_v2__ = {
    "hld_privacy_safe_files": {
        ...
        "notes": "The vault's index, .privacy_safe/db/privacy_safe.db, is a SQLCipher database "
                 ...
                 "sourced. Account held the same short numeric value that the preferences store "
                 "under number_password. Type, Encrypt Type and Delete Time are reported as "
                 "stored, no source for their code lists having been located. The index holds "
                 "eight further tables which were present and empty on all three corpora below "
                 "and so have no artifact here: NOTE, BOOKMARK, HIDE_APP, LOCK_APP, "
                 "INTRUDER_SHOOT, IMEI, PAY_ORDER and SAMPLE. From Folder is the "
                 "FROM_FOLDER_NAME column and was empty on every row of all three corpora below; "
                 "it is kept as a column, and what populates it was not exercised.",
