...
__artifacts_v2__ = {
    "intrusion_store_dns_events": {
        ...
        "notes": "Same events, same identifiers and same field values as the dns_event lines "
                 ...
                 "logging is enabled, per the AOSP NetworkEvent.java source at commit "
                 "664d64ffec5f6d657da71ca8e980a26a47be84eb of "
                 "github.com/aosp-mirror/platform_frameworks_base "
                 "(core/java/android/app/admin/), so Event ID is not unique across a store. IP "
                 "Count is stored "
    ...
    "intrusion_store_security_events": {
        ...
        "notes": "Each blob wraps a binary Android security log record; timestamps carry "
                 ...
                 "SecurityLogTags.logtags at commit 664d64ffec5f6d657da71ca8e980a26a47be84eb of "
                 "github.com/aosp-mirror/platform_frameworks_base, with the "
