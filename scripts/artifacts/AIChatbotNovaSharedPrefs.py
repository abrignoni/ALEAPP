__artifacts_v2__ = {
    "get_nova_momo_prefs": {
        ...
        "notes": ("Values are reported as stored in the preference files; JWT payloads are base64-decoded for display without signature verification. Developed against the author's own installation; no registered corpus image carries this app."),
