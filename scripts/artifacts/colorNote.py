__artifacts_v2__ = {
    "colornote_notes": {
        ...
        "notes": "One row per row of the notes table in "
                 ...
                 "UTC. Minor Modified is a second modification timestamp; which changes move it "
                 "was not established, so a row whose Minor Modified is later than its Modified "
                 "is reported without that difference being interpreted. A checklist keeps its "
                 ...
                 "Status 16 Trash, Storage 16 Archived and Reminder Type 32 Time alarm. Status "
                 ...
                 "Reminder, with Reminder Type reported beside it as stored. Encrypted, Latitude "
                 "and Longitude held no value on any row of the tested image. The decompiled "
