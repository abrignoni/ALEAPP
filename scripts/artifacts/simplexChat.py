__artifacts_v2__ = {
    ...
    "simplex_contacts": {
        ...
        "notes": "One row per contact. Read from the same encrypted database as the "
                 ...
                 "Full Name, Short Description and Incognito were empty on every row of the tested "
                 "device, and Favourite, Deleted, Unread Chat and Status were uniform there, so none "
                 "of those distinguished one contact from another on that sample. "
