__artifacts_v2__ = {
    "package_restrictions": {
        ...
        "notes": "Read from the per-user package-restrictions.xml under the system users folder, "
                 ...
                 "are reported as stored; an absent Enabled is reported blank, and what an "
                 "absent value means is not sourced here. Enabled Caller is the package the "
                 "platform recorded as having changed that state. Disabled Components and "
                 "Enabled Components list the component names the user's state overrides, joined "
                 "by a comma; they were blank for most packages on the tested images.\n"
        ...
        "sample_data": {
            ...
            "samsungs20_a13": "Android 13 | 1012 rows",
