__artifacts_v2__ = {
    "seal_downloads": {
        ...
        "notes": "One row per entry in the DownloadedVideoInfo table of databases/app_database. "
                 ...
                 "service the media came from (the tested download read ArchiveOrg). "
    ...
    "seal_config": {
        ...
        "notes": "Rows from the CookieProfile and CommandTemplate tables of "
                 ...
                 "CookieProfile row holds a set of cookies for a site that requires being signed "
                 "in, so its presence records the site and that cookies for a signed-in session "
                 "were stored; the Content column "
