__artifacts_v2__ = {
    "fossify_notes": {
        ...
        "notes": "One row per entry in the notes table of databases/notes.db. Each row is a note the app "
                 ...
                 "reported as stored. Protection is decoded from protection_type using the "
                 ...
                 "protection_hash column is not read or reported here. The notes table carries "
                 "no created or modified timestamp, so none is reported. The widgets table in "
                 "the same database is not parsed. The app is the maintained successor "
