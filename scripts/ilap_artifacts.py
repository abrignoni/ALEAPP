...
tosearch = {
    ...
    'usagestats':('Usage Stats', ('**/system/usagestats/*', '**/system**/usagestats')), # fs: matches only 1st level folders under usagestats/, tar/zip matches every single file recursively under usagestats/
